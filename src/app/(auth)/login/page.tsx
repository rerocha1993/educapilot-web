...
export default function LoginPage() {
  ...
  return (
    <main className="flex min-h-full flex-1 items-center justify-center bg-background p-4 md:p-6">
      <div className="flex w-full max-w-[380px] flex-col gap-4 overflow-hidden rounded-[10px] border border-border bg-card p-5 shadow-[0_1px_2px_rgba(0,0,0,.04)] md:p-7">
        {/* Único laranja da tela: um fio no topo do cartão, do mesmo tom da marca. */}
        <span aria-hidden className="-mx-5 -mt-5 h-[3px] bg-action-brand md:-mx-7 md:-mt-7" />
        <Image
          src="/logo.png"
          alt="EducaPilot"
          width={156}
